...
def tweets():
    ...
    ## 
    userid = app_handler.getUserId(username)
    tweets = app_handler.getTweets(userid)
    return tweets

@app.route('/personality',methods = ['GET','POST'])
def personality():
    username = request.args.get('username')
    personality = app_handler.getPersonality(username)
    return personality
...
def getRecommendation():
    ...
    """
    recommend = app_handler.getRecommendation(selection,personality)
...
def getProduct():
    ...
    details = app_handler.getProductDetails(id)
    return details

@app.route('/getProductByName',methods = ['GET','POST'])
def getProductByName():
    name = request.args.get('name')
    details = app_handler.getProductDetailsByName(name)
    return details
